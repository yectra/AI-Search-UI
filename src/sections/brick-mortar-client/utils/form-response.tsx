...
export const FormSchema = zod.object({
  ...
  message: zod
    ...
    .max(500, { message: 'Maximum 32 characters!' }),
  ...
  askExpert: zod
    ...
    .refine((val) => val !== '', { message: 'Expert is required!' })
...
export function FormResponseDialog({
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      await postFetcher([endpoints.client.serviceForm.create, { data }]);
      ...
      >
        ...
        <DialogContent>
          <Form methods={methods} onSubmit={onSubmit}>
            ...
            <Block>
              <Field.Phone name="phoneNumber" country="IN" placeholder="Phone Number" />
            </Block>
            {!location && (
              <Block sx={{ mt: 1 }}>
                <Field.Autocomplete
