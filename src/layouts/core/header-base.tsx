...
import { LocateVendorButton } from '../components/locate-vendor';
      ...
      slots={{
        ...
        leftArea: (
          <>
            ...
            {/* -- Logo -- */}
            <Logo data-slot="logo" width={120} height={80} />
        ...
        rightArea: (
          <>
            ...
            >
              ...
              {/* -- Searchbar -- */}
              {searchbar && <Searchbar data-slot="searchbar" data={data?.nav} width={320} />}
